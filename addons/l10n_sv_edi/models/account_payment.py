...
#    name_emisor = fields.Char(string=_('Name'))
    ...
    def importar_incluir_cep(self):
        ...
        return {
            ...
            'view_type': 'form',
            'view_mode': 'form',
            'view_id': self.env.ref('l10n_sv_edi.view_import_xml_payment_in_payment_form_view').id,
   ...
   #         self.fecha_pago = datetime.combine((self.date), datetime.max.time())
    ...
    def complete_payment(self):
        for p in self:
            ...
            if json_response.get('pago_xml'):
                ...
                report = self.env['ir.actions.report']._get_report_from_name('l10n_sv_edi.report_payment')
    ...
    def send_payment(self):
        self.ensure_one()
        template = self.env.ref('l10n_sv_edi.email_template_payment', False)
...
class MailTemplate(models.Model):
    ...
    def _get_file(self, url):
        url = url.encode('utf8')
        filename, headers = urllib3.urlretrieve(url)
    ...
    def generate_email(self, res_ids, fields=None):
        ...
        template_id = self.env.ref('l10n_sv_edi.email_template_payment')
...
class AccountPaymentTerm(models.Model):
    ...
    condicion_operacion = fields.Selection(
        ...
        string='Condición de la Operacion'
    )
